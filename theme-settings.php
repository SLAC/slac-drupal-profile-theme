 ...
 */
function slac_form_system_theme_settings_alter(array &$form, FormStateInterface $form_state, ?string $form_id = NULL): void {
  ...
  $form['back_to_top'] = [
    '#type' => 'details',
    '#title' => t('Back to Top'),
    '#open' => theme_get_setting('include_back_to_top', $theme) ?? TRUE,
  ];
  $form['back_to_top']['include_back_to_top'] = [
    '#type' => 'checkbox',
    '#title' => t('Include back to top'),
    '#default_value' => theme_get_setting('include_back_to_top', $theme) ?? TRUE,
  ];
  ...
  $form['breadcrumb']['include_current_page_in_breadcrumb'] = [
    ...
    '#default_value' => theme_get_setting('include_current_page_in_breadcrumb', $theme) ?? TRUE,
  ];
  ...
  $form['social_media_share_icons']['hide_social_media_share_icons'] = [
    ...
    '#default_value' => theme_get_setting('hide_social_media_share_icons', $theme),
    ];

  $form['slac_today_header_link'] =[
    '#type' => 'textfield',
    '#title' => t('Slac today header link'),
    '#default_value' => theme_get_setting('slac_today_header_link', $theme),
  ...
  $form['slac_web_search']['include_slac_web_search'] = [
    ...
    '#default_value' => theme_get_setting('include_slac_web_search', $theme) ?? FALSE,
  ];
  ...
  $form['slac_web_search']['search_this_site_placeholder'] = [
      ...
      '#default_value' => theme_get_setting('search_this_site_placeholder', $theme),
  ];
}
