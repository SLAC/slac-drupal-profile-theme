...
const BasicPage1 = {
  render: ({ has_sidebar, sidebar, ...args }) => (
    <PageWrapper {...args}>
      {PageTemplate.render({
        has_sidebar,
        sidebar,
        ...
        content: ReactDOMServer.renderToStaticMarkup(
          <>
                ...
                <SectionWrapper>
                  <WysiwygWrapper>
                    ...
                    <p>
                      ...
                      and excites site visitors to learn more. Nice to be short
                      and simple. This is a 35-word count paragraph example.
                      Lorem ipsum dolor sit amet lectus magna.
                    </p>
                    <h3>
                  ...
                  <WysiwygWrapper>
                    ...
                    <p>
                      Description provides an informative glimpse of the topic
                      and excites site visitors to learn more. Nice to be short
                      and simple. This is a 26-word count.
                    </p>
                    <p>
                      <a href="#0" className="c-button c-button--chevron">
                        Optional Button
                                ...
                                {WYSIWYG.render({
                                  content: ReactDOMServer.renderToStaticMarkup(
                                    <>
                                      ...
                                      <h3>
                                        Optional Heading to indicate what the
                                        next section is about lorem ipsum
                                      </h3>
                                      <ul>
                                        <li>
                                          Lorem ipsum dolor sit amet,
                                          consectetur adipiscing elit. Tincidunt
                                          non sit facilisi ac ipsum.
                                        </li>
                                        <li>
                                          Lorem ipsum dolor sit amet,
                                          consectetur adipiscing elit. Tincidunt
                              ...
                              <SectionWrapper>
                                {WYSIWYG.render({
                                  content: ReactDOMServer.renderToStaticMarkup(
                                    <>
                                      <h2>
                                        Title that grabs attention and
                                        accurately describes topic
                                      </h2>
                                      <p>
                                        Description provides an informative
                                        glimpse of the topic and excites site
            ...
            {Section.render({
              ...
              section_buttons: false,
              section_content: ReactDOMServer.renderToStaticMarkup(
                WideAccordion.render(WideAccordion.args)
              ),
            })}
            {Section.render({
              ...Section.args,
                      ...
                      content: ReactDOMServer.renderToStaticMarkup(
                        <>
                          ...
                          <p>
                            ...
                            Porttitor egestas est rhoncus placerat est urna,
                            vitae egestas. Elementum adipiscing amet turpis
                            faucibus lorem sit et faucibus.
                          </p>
                          <h4>
                            Optional Header to help describe lorem psum dolor
                            sit{' '}
                          </h4>
                          <p>
                            Optional paragraph text to help describe lorem ipsum
                ...
                content: ReactDOMServer.renderToStaticMarkup(
                  <>
                    ...
                    <p>
                      ...
                      sit amet, consectetur adipiscing elit. Porttitor egestas
                      est rhoncus placerat est urna, vitae egestas. Elementum
                    ...
                    <p>
                      Optional paragraph text to help describe lorem ipsum sit
                      et faucibus. Sit eget augue magna ultrices non dictumst.
                    </p>
                  </>
                ),
              })}
              {NarrowAccordion.render(NarrowAccordion.args)}
            </SectionWithPaddingWrapper>
          </>
        ),
      })}
