...
const NewsArticleDetail = {
  render: ({ show_admin_info, ...args }) => (
    <PageWrapper
      hero={HeroWithoutOverlay.render({
      ...
      {NewsArticle.render({
        ...
        content: ReactDOMServer.renderToStaticMarkup(
          <>
                ...
                content: ReactDOMServer.renderToStaticMarkup(
                  <>
                    ...
                    <p>
                      ...
                      University and the Kavli Institute for Particle Physics
                      and Astrophysics at the Department of Energy’s SLAC
                      National Accelerator Laboratory, and an international team
                      of researchers have a new answer that may, once refined
                      with more data, help resolve the debate.{' '}
                    </p>
                  </>
                ),
              })}
            ...
            <SectionWrapper>
              <WysiwygWrapper>
                <p>
                  ...
                  method called time-delay cosmography with new assumptions and
                  additional data to derive a new estimate of the Hubble
                ...
                <p>
                  ...
                  always reconsider our assumptions. Our recent work is exactly
                  in this spirit.”
                </p>
              </WysiwygWrapper>
            </SectionWrapper>
            <SectionWithPaddingWrapper>
              {FiftyFiftyLeftFadeIn.render({
                    ...
                    content: ReactDOMServer.renderToStaticMarkup(
                      <>
                        ...
                        <p>
                          ...
                          cosmos is expanding, and in that time they have
                          settled on two main ways to measure that expansion.
                          One method is the cosmic distance ladder, a series of
                          steps that help estimate the distance to far-away
                          supernovae. By examining the spectrum of light from
                          these supernovae, scientists can calculate how quickly
                          they’re receding from us, then divide by distance to
                          estimate the Hubble constant. (The Hubble constant is
                          usually measured in kilometers per second per
                          megaparsec, reflecting the fact that space itself is
                          growing, so that more distant objects recede from us
                          faster than nearer objects.)
                        </p>
                      </>
                    ),
                  })
            ...
            <SectionWrapper>
              <WysiwygWrapper>
                <p>
                  ...
                  the cosmic microwave background radiation, or CMB. Those
                  ripples result from sound waves traveling through plasma in
                  the early universe. By measuring the ripples’ size they can
                  infer how long ago and how far away the CMB light we see today
                  was created.
                </p>
                <p>
                  Both approaches, however, have drawbacks. Sound-wave methods
                  rely heavily on how sound travelled in the early universe,
                  which depends in turn on the particular mix of types of matter
                  at the time, on how long sound waves travelled before leaving
                  their imprint on the CMB, and on assumptions about the
                  expansion of the universe since that time. Meanwhile, cosmic
                  distance ladder methods chain together a series of estimates,
                  starting with radar estimates of the distance to the sun and
                  parallax estimates of the distance to pulsating stars called
                  cepheids. That introduces a chain of calibrations and
                  measurements, each of which needs to be precise and accurate
                  enough to ensure a reliable estimate of the Hubble constant.
                </p>
                <h3>A lens from the past</h3>
                <p>
                  But there is a way to measure distances more directly, based
                  on what are called strong gravitational lenses. Gravity bends
                  spacetime itself and with it the path light takes through the
                  cosmos. One special case is when a very massive object, such
                  as a galaxy, bends the light of a distant object around such
                  that light reaches us along multiple different paths,
                  effectively creating multiple images of the same background
                  object.
                </p>
              </WysiwygWrapper>
            </SectionWrapper>
            <SectionWithPaddingWrapper>
              {FiftyFiftyRightFadeIn.render({
                ...
                col_1: ReactDOMServer.renderToStaticMarkup(
                  <WysiwygWrapper>
                    ...
                    <p>
                      ...
                      cosmography, from idea to reality. Successive measurements
                      and a dedicated effort by the H0LiCOW, COSMOGRAIL,
                      STRIDES, and SHARP teams, now under the joint umbrella
                      organization TDCOSMO, culminated in a precise Hubble
                      constant measurement at around 73 kilometers per second
                      per megaparsec with a precision of 2%.
                    </p>
                  </WysiwygWrapper>
                ),
              })}
            ...
            <SectionWrapper>
              <WysiwygWrapper>
                ...
                <p>
                  ...
                  been accurate enough to conclude that the Hubble constant was
            ...
            <SectionWithPaddingWrapper>
              {FigureCenteredWide.render(FigureCenteredWide.args)}
            </SectionWithPaddingWrapper>
            <SectionWrapper>
              <WysiwygWrapper>
                {FigureRight.render({
                ...
                <p>
                  ...
                  performed without knowing the resulting outcome on the Hubble
                  constant – to avoid experimenter bias, a procedure established
                  already in the previous analyses of the team and an integral
                  part in moving forward, Birrer said.
                </p>
                <p>
                ...
                <p>
                  ...
                  galactic structure, the Hubble constant estimate went down to
                  about 67 kilometers per second per megaparsec, with a 5%
                  uncertainty, in good agreement with sound-wave estimates such
                  as that from the CMB, but also statistically consistent with
                  the previous determinations, given the uncertainties.
                </p>
              </WysiwygWrapper>
            </SectionWrapper>
            <SectionWrapper>
            ...
            <SectionWrapper>
              <WysiwygWrapper>
                <p>
                  ...
                  back most of the precision we previously had achieved based on
                  ...
                  step and paves the way to utilizing these upcoming data sets
                  to provide a definite conclusion on the remaining problem.”
                </p>
                <p>
                ...
                <p className="c-small-paragraph">
                  ...
                  the Packard Foundation, the Kavli Foundation, the Danish
                  Council for Independent Research, the Villum Foundation, the
                  Royal Astronomical Society, the European Research Council, the
                  Hintze Family Charitable Foundation, the Max Planck Society,
                  the World Premier International Research Center Initiative and
            ...
            <SectionWrapper>
              <WysiwygWrapper>
                ...
                <p className="c-small-paragraph">
                  ...
                  the universe works at the biggest, smallest and fastest scales
                  and invents powerful tools used by scientists around the
                  globe. With research spanning particle physics, astrophysics
                  and cosmology, materials, chemistry, bio- and energy sciences
                  and scientific computing, we help solve real-world problems
